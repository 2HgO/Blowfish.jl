...
```
"""
function NewCipher(key::Array{UInt8, 1}) :: Cipher
...
```
"""
function NewSaltedCipher(key::Array{UInt8, 1}, salt::Array{UInt8, 1}) :: Cipher
...
"""
function Encrypt!(c::Cipher, dst::Array{UInt8, 1}, src::Array{UInt8, 1})
...
"""
function Decrypt!(c::Cipher, dst::Array{UInt8, 1}, src::Array{UInt8, 1})
	l = UInt32(src[1])<<24 | UInt32(src[2])<<16 | UInt32(src[3])<<8 | UInt32(src[4])
	r = UInt32(src[5])<<24 | UInt32(src[6])<<16 | UInt32(src[7])<<8 | UInt32(src[8])
